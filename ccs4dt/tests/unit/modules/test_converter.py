...
def test_coordinate_offset_no_rotation():
    ...
    converter.add_sensor('sensor_1', x_origin=1, y_origin=1.5, z_origin=1, y_rotation=0, measurement_unit='cm')
...
def test_coordinate_offset_with_rotation():
    ...
    converter = Converter(input)
    converter.add_sensor('sensor_2', x_origin=8, y_origin=4.5, z_origin=1, y_rotation=90, measurement_unit='m')
    output = converter.run()
